  ...
  return (
    <div className="panel ar-settings">
      ...
      <details className="ar-details">
        ...
        {/* The same export the app offers outside AR, plus the camera frame,
            which only exists while the passthrough is running. */}
        <DiagnosticsExport capabilities={capabilities} inAr />
